      ...
      {NAV_ITEMS.map((navItem) => (
        <Box
          ...
          onClick={() => {
            ...
            window.scrollTo({ top: navItem.scrollObj.top, ...scrollOptions });
          }}
        >
    ...
    <Stack spacing={4} onClick={children && onToggle}>
      <Flex
        ...
        onClick={() => {
          ...
          window.scrollTo({ top: scrollObj.top, ...scrollOptions });
          onClose();
        }}
      >
        <Text
      ...
      <Collapse in={isOpen} animateOpacity style={{ marginTop: "0!important" }}>
        ...
        >
          {children &&
            children.map((child) => (
              // className={`nav-link ${child.class} ${child.label.toLowerCase()}`}
              <RouterLink key={child.label} py={2} to={child.to} >
                {child.label}
              </RouterLink>
            ))}
        </Stack>
